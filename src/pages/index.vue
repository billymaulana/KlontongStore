  ...
  <section v-if="listProducts || listfilterProducts">
    <div lg="container w-full min-h-screen h-full overflow-hidden" text="text-black dark:text-gray-200">
      <div row justfy-center min-h-screen overflow-hidden px-20 mx-auto sm="py-20" lg="py-24">
        <div w-full flex justify-between>
          <div class="pb-4 bg-white dark:bg-gray-900">
            ...
            <div class="relative mt-1">
              ...
              <input id="table-search" v-model="search" type="text" class="block p-2 pl-10 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" @keyup="searchProduct" @change="searchProduct">
            </div>
          </div>
        ...
        <div flex items-center justify-end w-full mt-5>
