        ...
        <div col-12>
          ...
          <form w-full mx-auto block mt-10 @submit.prevent="submitNewProduct">
            ...
            <div class="mb-5">
              ...
              <textarea v-model="productData.description" class="form-control h-full" type="text" cols="5" rows="10" />
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
              ...
              <input v-model="productData.price" class="form-control" type="number">
            </div>
            <div class="mb-5">
